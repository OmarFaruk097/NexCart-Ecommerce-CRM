...
const InventoryControl = () => {
  ...
  const fetchProducts = () => {
    fetch('https://nexcart-ecommerce-crm.onrender.com/api/products')
      .then(res => res.json())
      .then(data => {
        setProducts(data);
        setLoading(false);
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      const res = await fetch('https://nexcart-ecommerce-crm.onrender.com/api/crm/products', {
        method: 'POST',
  ...
  const handleDeleteProduct = async (id) => {
    ...
    try {
      const res = await fetch(`https://nexcart-ecommerce-crm.onrender.com/api/crm/products/${id}`, { method: 'DELETE' });
      if (res.ok) {
        fetchProducts();
      }
    } catch (err) {
